...
#define StaticHandle(type,var) struct type##_struc : public Standard_Transient { Handle(type) H; }; static Handle(type##_struc) var##_s = NULL

//  Another declaration for an already declared type (with StaticHandle)
#define StaticHandleA(type,var) static Handle(type##_struc) var##_s = NULL
